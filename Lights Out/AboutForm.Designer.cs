namespace Lights_Out
{
	partial class AboutForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.Okay.Location = new System.Drawing.Point(99, 198);
			this.Okay.Name = "Okay";
			...
			this.label2.Text = "By: Lauren Ragland";
			// 
			// label3
			// 
			...
			this.label3.Text = "Turn out all the lights to win the game!";
			// 
			// pictureBox1
			// 
			this.pictureBox1.Image = global::Lights_Out.Properties.Resources.lightbulb1;
